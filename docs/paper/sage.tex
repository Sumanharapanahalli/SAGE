...
\begin{tikzpicture}[
    ...
    \node[layer=red,     below=of conn]   (api)     {FastAPI (227+ endpoints)};
    \node[layer=yellow,  below=of api]    (ui)      {React Dashboard (39 pages)};
