...
\begin{tikzpicture}[
    ...
    \node[layer=red,     below=of runners](api)     {FastAPI (190+ endpoints)};
    \node[layer=yellow,  below=of api]    (ui)      {React Dashboard (26 pages)};
