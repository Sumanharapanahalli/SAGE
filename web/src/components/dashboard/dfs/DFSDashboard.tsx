      ...
      <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="bg-orange-50 rounded-lg p-3 text-center">
            <CheckCircle2 size={14} className="text-orange-500 mx-auto mb-1" />
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between bg-gray-50 rounded-lg px-3 py-2">
              ...
              <span className="text-sm font-bold text-orange-600 font-mono">{firmware.latest}</span>
            </div>
            <div className="flex items-center justify-between bg-gray-50 rounded-lg px-3 py-2">
            ...
            <div className="flex items-center justify-between pt-1">
              <span className="text-xs text-orange-600">{firmware.upToDate} up to date</span>
