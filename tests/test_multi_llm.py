...
class TestParallelGeneration:
        ...
        pool = self._make_pool(
            {
                ...
                "detailed": MockProvider(
                    "detailed",
                    response="This is a very detailed and thorough analysis of the problem.",
                ),
            }
        )
        result = generate_parallel(
    ...
    def test_parallel_ignores_failed_in_voting(self):
        ...
        result = generate_parallel(
            ...
            "sys",
            strategy="voting",
            provider_names=["good1", "good2", "broken"],
        )
