...
class TestExecute:
        ...
        with (
            ...
            patch(
                ...
                return_value=MagicMock(
                    returncode=0, stdout="val_loss: 2.80", stderr=""
                ),
            ),
        ):
    ...
    def test_execute_error_returns_error_status(self):
        ...
        with patch(
            "src.core.auto_research.AutoResearchEngine.run_experiment",
...
class TestGrading:
    ...
    def test_grade_returns_score(self):
        ...
        with patch(
            "src.core.llm_gateway.llm_gateway.generate",
            return_value=json.dumps({"score": 75, "feedback": "good", "hints": []}),
        ):
