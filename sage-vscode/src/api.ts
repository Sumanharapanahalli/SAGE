...
// Analyst proposal created in this session (from /analyze)
...
// Pending approval from the backend ProposalStore (from /proposals/pending)
...
export class SageApiClient {
  ...
  async pendingProposals(): Promise<{ proposals: BackendProposal[]; count: number }> {
