...
def stat_card(slide, x, y, w, h, number, label, accent=SAGE_GREEN):
    ...
    add_rect(
        slide, x, y, w, h, fill_color=WHITE, line_color=SAGE_GREEN_L, line_width=Pt(1.5)
    )
    add_text_box(
        slide,
        number,
...
def diagram_box(
    slide, x, y, w, h, text, fill=SAGE_GREEN_L, text_color=SAGE_GREEN_D, font_size=11
):
    """Diagram building block — emerald themed."""
    add_rect(
        slide, x, y, w, h, fill_color=fill, line_color=SAGE_GREEN, line_width=Pt(1)
    )
    add_text_box(
        slide,
        text,
...
def build_tech_deck():
    ...
    add_text_box(
        slide,
        "The Lean AI Agent Framework for Regulated Industries",
        Inches(1),
        Inches(3.55),
        Inches(11),
        Inches(0.5),
    ...
    add_text_box(
        slide,
        "Open Source (MIT)  ·  Self-Hosted  ·  Zero API Keys Required  ·  Air-Gappable",
        Inches(1),
        Inches(6.0),
        Inches(11),
        Inches(0.4),
    ...
    pillars = [
        (
            "Lean Development",
            "Eliminate waste, shorten feedback\nloops, amplify human judgment",
        ),
        (
            "Agentic AI",
            "Autonomous agents that propose,\nlearn, and compound intelligence",
        ),
        (
            "Human-in-the-Loop",
            "Every AI write action requires\nhuman approval — always",
        ),
    ]
    pw = Inches(3.4)
    pgap = Inches(0.4)
    ...
    for i, (title, desc) in enumerate(pillars):
        ...
        add_rect(
            ...
            pw,
            Inches(2.2),
            fill_color=SAGE_GREEN_L,
            line_color=SAGE_GREEN,
            line_width=Pt(1),
        )
        add_text_box(
            slide,
    ...
    header_band(
        ...
        "Data flows one way: UI → API → Agents → LLM → Audit Log",
    )
    ...
    add_text_box(
        slide,
        "→  Phase 5 feeds back into Phase 2. Every human decision compounds intelligence for the next task.",
        Inches(0.6),
        Inches(6.35),
        Inches(12),
        Inches(0.35),
    ...
    header_band(
        slide,
        "SAGE by the Numbers",
        "Everything built. Everything tested. Everything live.",
    )
    ...
    stats = [
        ...
        (
            "32",
            "Build Task Types",
            "SW, HW, firmware, QA, legal,\nbusiness, design, ops, ML",
        ),
        (
            "7",
            "LLM Providers",
            "Gemini, Claude, Ollama, local\nGGUF, generic CLI + pool",
        ),
        (
            "840+",
            "Tests Passing",
    ...
    add_text_box(
        slide,
        "5 Risk Tiers — proposals auto-expire based on risk level",
        Inches(0.5),
        top,
        Inches(12),
        Inches(0.35),
    ...
    add_text_box(
        slide,
        "Approval Flow:   Agent proposes  →  Proposal created (risk-ranked)  →  /approvals inbox  →  Human reviews  →  Approve / Reject with feedback  →  Audit log + vector memory updated",
        Inches(0.5),
        top,
        Inches(12.3),
        Inches(0.5),
    ...
    add_text_box(
        slide,
        "Slack integration:  Block Kit approval cards → /webhook/slack callback → two-way approval without leaving Slack",
        Inches(0.5),
        top,
        Inches(12.3),
        Inches(0.4),
    ...
    header_band(
        slide,
        "Build Orchestrator — Idea to Working Product",
    ...
    add_text_box(
        slide,
        "5 Workforce Teams — 20 Agent Roles",
        Inches(0.5),
        top,
        Inches(6),
        Inches(0.35),
    ...
    add_text_box(
        slide,
        "14 Industry Domains Auto-Detected",
        Inches(7),
        Inches(3.0),
        Inches(6),
        Inches(0.35),
    ...
    add_text_box(
        slide,
        "3 HITL Levels:  minimal (final only)  ·  standard (plan + final)  ·  strict (plan + per-component + final)",
        Inches(0.5),
        Inches(5.8),
        Inches(12),
        Inches(0.35),
    ...
    add_text_box(
        slide,
        "Adaptive Router:  Q-learning agent routing — learns which agent performs best per task type. 3+ observations before overriding defaults.",
        Inches(0.5),
        Inches(6.5),
        Inches(12),
        Inches(0.35),
    ...
    providers = [
        ...
        [
            "Ollama",
            "ollama.com → ollama serve → ollama pull",
            "Fully offline",
            "llama3.2, mistral, qwen2.5",
        ],
        [
            "Local GGUF",
            "pip install llama-cpp-python + model",
            "Air-gapped, GPU-direct",
            "Any .gguf model",
        ],
        [
            "Claude API",
    ...
    add_text_box(
        slide,
        "ProviderPool — Parallel Generation Strategies",
        Inches(0.5),
        top,
        Inches(12),
        Inches(0.35),
    ...
    add_text_box(
        slide,
        "Teacher-Student Distillation:  Heavy model (GPT-4/Claude) → confidence scoring → auto-capture training data → student handles 80% of tasks over time",
        Inches(0.5),
        top,
        Inches(12),
        Inches(0.4),
    ...
    add_text_box(
        slide,
        "Standards Supported:  IEC 62304 · ISO 13485 · ISO 14971 · FDA 21 CFR 820 · ISO 26262 · DO-178C · DO-254 · PCI DSS · HIPAA · SOC 2 · ISO 27001 · FERPA · COPPA · IEC 62443 · WCAG 2.1",
        Inches(0.6),
        Inches(6.25),
        Inches(12),
        Inches(0.5),
    ...
    slide_bg(slide)
    header_band(
        slide, "Key Capabilities", "Everything built, tested, and production-ready"
    )

    features = [
        (
            "Conversational Onboarding",
            "Point at a repo or describe your domain\n→ 3 YAML files generated by LLM",
        ),
        (
            "SWE Agent (open-swe)",
            "Submit task → autonomous coding →\ntests → PR → founder reviews",
        ),
        (
            "Visual Workflows",
            "LangGraph → auto-generated Mermaid\ndiagrams on /workflows page",
        ),
        (
            "Parallel Task Execution",
            "Wave scheduling — concurrent agents,\nwait only where dependencies exist",
        ),
        (
            "Action-Aware Chat",
            "Chat classifies intent → shows\nconfirmation card → executes on confirm",
        ),
        (
            "Eval / Benchmarking",
            "YAML test suites per solution,\nkeyword scoring, SQLite history",
        ),
        (
            "Knowledge Base CRUD",
            "Vector store per solution,\nbulk import, semantic search",
        ),
        (
            "Org Chart + Traceability",
            "Agent hierarchy, live status,\ndaily task counts, audit drill-down",
        ),
        (
            "HIL Testing",
            "Hardware-in-the-loop — flash firmware,\nrun tests, generate regulatory evidence",
        ),
        (
            "Agent Budgets",
            "Monthly call ceilings per agent\nrole — declared in project.yaml",
        ),
        (
            "Git Worktrees",
            "Isolated worktree per code_diff\nproposal — concurrent, no conflicts",
        ),
        (
            "Theme System",
            "Per-solution branding via CSS vars\n— project.yaml → ThemeProvider",
        ),
    ]
    ...
    header_band(
        slide,
        "When to Choose SAGE",
        "Decision guide for teams evaluating agent frameworks",
    )
    ...
    decisions = [
        ...
        (
            "Is speed of prototyping the top priority, no compliance?",
            "→ CrewAI",
            SAGE_GRAY,
        ),
        (
            "Is Docker-sandboxed code execution the core feature?",
            "→ AutoGen",
            SAGE_GRAY,
        ),
    ...
    for question, answer, color in decisions:
        is_sage = (
            "SAGE" in answer and "LangGraph" not in answer and "CrewAI" not in answer
        )
    ...
    add_text_box(
        slide,
        "By Industry:  Medical → SAGE  |  Manufacturing → SAGE  |  Legal → SAGE  |  Fintech → SAGE/LangGraph  |  DevOps → LangGraph  |  Marketing → CrewAI/Dify",
        Inches(0.5),
        top,
        Inches(12.3),
        Inches(0.4),
    ...
    table_slide(
        ...
        [
            ...
            [
                "1",
                "LlamaIndex + LangChain + mem0",
                "vector_store.py, langchain_tools.py",
                "✅ Live",
            ],
    ...
    areas = [
        ...
        (
            ...
            "Analyst · Developer · Monitor · Agents · Improvements · Workflows · Goals",
        ),
        ...
        (
            ...
            "●",
            SAGE_GRAY,
            "LLM · YAML Editor · Access Control · Integrations · Settings",
        ),
    ]
    ...
    add_text_box(
        slide,
        "No API keys. No cloud accounts. Runs on your laptop. MIT licensed.",
        Inches(1),
        Inches(5.6),
        Inches(11),
        Inches(0.4),
    ...
    add_text_box(
        slide,
        "cp -r solutions/starter solutions/my_domain && make run PROJECT=my_domain",
        Inches(1.15),
        Inches(6.4),
        Inches(5),
        Inches(0.25),
    ...
    add_text_box(
        slide,
        "POST /onboarding/generate → describe your domain → 3 YAML files auto-generated",
        Inches(6.75),
        Inches(6.4),
        Inches(5.4),
        Inches(0.25),
    ...
    add_text_box(
        slide,
        "Auditor transparency — regulators can inspect the entire AI agent toolchain.  No vendor lock-in — fork it, own it.  Community security review — continuous scrutiny reduces vulnerabilities in compliance-critical paths.",
        Inches(0.7),
        Inches(5.8),
        Inches(12),
        Inches(0.4),
    ...
    add_text_box(
        slide,
        "Lean Development × Agentic AI × Human Oversight",
        Inches(1),
        Inches(2.7),
        Inches(11),
        Inches(0.5),
    ...
    add_text_box(
        slide,
        "136 endpoints  ·  30 pages  ·  840+ tests  ·  20 agent roles  ·  14 domains  ·  7 LLM providers",
        Inches(1),
        Inches(3.8),
        Inches(11),
        Inches(0.4),
    ...
    add_text_box(
        slide,
        "Open Source (MIT)  ·  Self-Hosted  ·  Air-Gappable  ·  Zero API Keys Required",
        Inches(1),
        Inches(4.3),
        Inches(11),
        Inches(0.4),
...
def table_slide_helper(slide, left, top, headers, rows, col_widths):
    ...
    table = slide.shapes.add_table(
        n_rows + 1, n_cols, left, top, sum(col_widths), tbl_h
    ).table
